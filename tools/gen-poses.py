...
SKINS = {
    ...
    "angel":      ("angel",           "large white and gold feathered wings, a jewelled gold crown, white and gold robes, and he HOLDS A TALL GOLD SCEPTRE with a glowing orb at its top in one hand. Floating above his crown is a slim GOLDEN HOOP, like a thin polished gold bracelet lying flat in the air and tilted so you see it as a narrow ellipse. It is solid gold metal the whole way round, and the middle of the hoop is OPEN AIR — the background shows through the hole. It must NOT contain a dark centre, a black fill, a night sky, stars or a galaxy. It is a plain gold ring, nothing else."),
